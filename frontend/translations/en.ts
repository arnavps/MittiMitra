export const en = {
    ...
    observabilityLayer: "The Observability Layer",
    smartLogicActive: "Smart Logic Active",
    sensorActive: "Sensors Online",
    nodeId: "Node ID",
    activeAlerts: "Active Nearby Threats",
    reportIssue: "Report Issue",
    geofencingActive: "Geofencing Active",
    hyperLocalForecast: "Hyper-local Forecast",
    stormWatch: "Storm Watch",
    inputLedger: "Input Ledger",
    orderInputs: "Order Inputs",
    blockchainProvenance: "Blockchain Provenance",
    optimal: "Optimal",
