...
const ONBOARDING_STRINGS: Record<string, any> = {
    ...
    "Telugu": {
        greeting: "నమస్కారం! నేను మిట్టిమిత్ర. మీకు ఉత్తమ లాభదాయకమైన మార్కేట్లను కనుగొనడానికి, మీ జిపిఎస్ మరియు పంట డేటాను ఉపయోగించడానికి నాకు మీ అనుమదు అవసరం. నేను కొనసాగించవచ్చా?",
    ...
    "Punjabi": {
        greeting: "ਸਤਿ ਸ੍ਰੀ ਅਕਾਲ! ਮੈਂ ਮਿੱਟੀਮਿੱਤਰ ਹਾਂ। ਤੁਹਾਡੇ ਲਈ ਸਭ ਤੋਂ ਵਧੀਆ ਮੁਨਾਫ਼ਾ ਵਾਲੀਆਂ ਮੰਡੀਆਂ ਲੱਭਣ ਲਈ, ਮੈਨੂੰ ਤੁਹਾਡੇ ਜੀਪੀਐਸ ਅਤੇ ਫ਼ਸਲ ਦੇ ਡੇਟਾ ਦੀ ਵਤੋਂ ਕਰਨ ਦੀ ਇਜਾਜ਼ਤ ਚਾਹੀਦੀ ਹੈ। ਕੀ ਮੈਂ ਅੱਗੇ ਵਧ ਸਕਦਾ ਹਾਂ?",
        ...
        error_parsing: "ਮਾਫ਼ ਕਰਨਾ, ਮੈਨੂੰ ਇਸ ਨੂੰ समझਣ ਵਿੱਚ ਮੁਸ਼ਕਲ ਆਈ ਹੈ। ਕੀ ਤੁਸੀਂ ਕਿਰਪਾ ਕਰਕੇ ਦੁਬਾਰਾ ਕਹਿ ਸਕਦੇ ਹੋ?",
...
const ONBOARDING_STRINGS: Record<string, any> = {
    ...
    "Hindi": {
        greeting: "à¤¨à¤®à¤¸à¥�à¤¤à¥‡! à¤®à¥ˆà¤‚ à¤®à¤¿à¤Ÿà¥�à¤Ÿà¥€à¤®à¤¿à¤¤à¥�à¤° à¤¹à¥‚à¤�à¥¤ à¤†à¤ªà¤•à¥‡ à¤²à¤¿à¤� à¤¸à¤¬à¤¸à¥‡ à¤…à¤šà¥�à¤›à¥‡ à¤²à¤¾à¤­ à¤–à¤¿à¥œà¤•à¤¿à¤¯à¤¾à¤‚ à¤–à¥‹à¤œà¤¨à¥‡ à¤•à¥‡ à¤²à¤¿à¤�, à¤®à¥�à¤�à¥‡ à¤†à¤ªà¤•à¥‡ à¤œà¥€à¤ªà¥€à¤�à¤¸ à¤”à¤° à¤«à¤¸à¤² à¤¡à¥‡à¤Ÿà¤¾ à¤•à¤¾ à¤‰à¤ªà¤¯à¥‹à¤— à¤•à¤°à¤¨à¥‡ à¤•à¥€ à¤†à¤µà¤¶à¥�à¤¯à¤•à¤¤à¤¾ à¤¹à¥ˆà¥¤ à¤•à¥�à¤¯à¤¾ à¤®à¥�à¤�à¥‡ à¤†à¤—à¥‡ à¤¬à¤¢à¤¼à¤¨à¥‡ à¤•à¥‡ à¤²à¤¿à¤� à¤†à¤ªà¤•à¥€ à¤…à¤¨à¥�à¤®à¤¤à¤¿ à¤¹à¥ˆ?",
        location_success: "à¤¸à¥�à¤¥à¤¾à¤¨ à¤ªà¥�à¤°à¤¾à¤ªà¥�à¤¤ à¤¹à¥�à¤†à¥¤ à¤•à¥�à¤¯à¤¾ à¤†à¤ªà¤•à¥€ à¤«à¤¸à¤² à¤ªà¤¹à¤²à¥‡ à¤¹à¥€ à¤•à¤Ÿ à¤šà¥�à¤•à¥€ à¤¹à¥ˆ, à¤¯à¤¾ à¤†à¤ª à¤…à¤­à¥€ à¤‡à¤¸à¤•à¥‡ à¤ªà¤•à¤¨à¥‡ à¤•à¤¾ à¤‡à¤‚à¤¤à¤œà¤¾à¤° à¤•à¤° à¤°à¤¹à¥‡ à¤¹à¥ˆà¤‚?",
        location_error: "à¤¸à¥�à¤¥à¤¾à¤¨ à¤ªà¥�à¤°à¤¾à¤ªà¥�à¤¤ à¤•à¤°à¤¨à¥‡ à¤®à¥‡à¤‚ à¤¸à¤®à¤¸à¥�à¤¯à¤¾ à¤¹à¥�à¤ˆ, à¤²à¥‡à¤•à¤¿à¤¨ à¤¹à¤® à¤†à¤—à¥‡ à¤¬à¤¢à¤¼ à¤¸à¤•à¤¤à¥‡ à¤¹à¥ˆà¤‚à¥¤ à¤•à¥�à¤¯à¤¾ à¤†à¤ªà¤•à¥€ à¤«à¤¸à¤² à¤ªà¤¹à¤²à¥‡ à¤¹à¥€ à¤•à¤Ÿ à¤šà¥�à¤•à¥€ à¤¹à¥ˆ?",
        error_parsing: "à¤•à¥�à¤·à¤®à¤¾ à¤•à¤°à¥‡à¤‚, à¤®à¥�à¤�à¥‡ à¤¸à¤®à¤�à¤¨à¥‡ à¤®à¥‡à¤‚ à¤¦à¤¿à¤•à¥�à¤•à¤¤ à¤¹à¥�à¤ˆà¥¤ à¤•à¥ƒà¤ªà¤¯à¤¾ à¤«à¤¿à¤° à¤¸à¥‡ à¤•à¤¹à¥‡à¤‚à¥¤",
        camera_success: "à¤—à¥�à¤£à¤µà¤¤à¥�à¤¤à¤¾ à¤¡à¥‡à¤Ÿà¤¾ à¤•à¤¾ à¤µà¤¿à¤¶à¥�à¤²à¥‡à¤·à¤£ à¤•à¤¿à¤¯à¤¾ à¤—à¤¯à¤¾à¥¤ à¤†à¤ª à¤…à¤ªà¤¨à¥€ à¤‰à¤ªà¤œ à¤•à¤¾ à¤ªà¤°à¤¿à¤µà¤¹à¤¨ à¤•à¥ˆà¤¸à¥‡ à¤•à¤°à¥‡à¤‚à¤—à¥‡? à¤¦à¥‹à¤ªà¤¹à¤¿à¤¯à¤¾, à¤Ÿà¥�à¤°à¥ˆà¤•à¥�à¤Ÿà¤°, à¤¯à¤¾ à¤ªà¤¿à¤•à¤…à¤ª à¤Ÿà¥�à¤°à¤•?"
    },
    "Marathi": {
        greeting: "à¤¨à¤®à¤¸à¥�à¤•à¤¾à¤°! à¤®à¥€ à¤®à¤¿à¤Ÿà¥�à¤Ÿà¥€à¤®à¤¿à¤¤à¥�à¤° à¤†à¤¹à¥‡. à¤¤à¥�à¤®à¤šà¥�à¤¯à¤¾à¤¸à¤¾à¤ à¥€ à¤¸à¤°à¥�à¤µà¥‹à¤¤à¥�à¤¤à¤® à¤¨à¤«à¤¾ à¤¶à¥‹à¤§à¤£à¥�à¤¯à¤¾à¤¸à¤¾à¤ à¥€, à¤®à¤²à¤¾ à¤¤à¥�à¤®à¤šà¤¾ à¤œà¥€à¤ªà¥€à¤�à¤¸ à¤†à¤£à¤¿ à¤ªà¤¿à¤•à¤¾à¤šà¤¾ à¤¡à¥‡à¤Ÿà¤¾ à¤µà¤¾à¤ªà¤°à¤£à¥�à¤¯à¤¾à¤šà¥€ à¤ªà¤°à¤µà¤¾à¤¨à¤—à¥€ à¤¹à¤µà¥€ à¤†à¤¹à¥‡. à¤®à¥€ à¤ªà¥�à¤¢à¥‡ à¤œà¤¾à¤Š à¤¶à¤•à¤¤à¥‹ à¤•à¤¾?",
        location_success: "à¤¸à¥�à¤¥à¤¾à¤¨ à¤ªà¥�à¤°à¤¾à¤ªà¥�à¤¤ à¤�à¤¾à¤²à¥‡. à¤¤à¥�à¤®à¤šà¥€ à¤ªà¤¿à¤•à¤¾à¤šà¥€ à¤•à¤¾à¤ªà¤£à¥€ à¤†à¤§à¥€à¤š à¤�à¤¾à¤²à¥€ à¤†à¤¹à¥‡, à¤•à¥€ à¤¤à¥�à¤®à¥�à¤¹à¥€ à¤…à¤œà¥‚à¤¨ à¤¤à¥€ à¤ªà¤¿à¤•à¤£à¥�à¤¯à¤¾à¤šà¥€ à¤µà¤¾à¤Ÿ à¤ªà¤¾à¤¹à¤¤ à¤†à¤¹à¤¾à¤¤?",
        location_error: "à¤¸à¥�à¤¥à¤¾à¤¨ à¤®à¤¿à¤³à¤µà¤£à¥�à¤¯à¤¾à¤¤ à¤…à¤¡à¤šà¤£ à¤†à¤²à¥€, à¤ªà¤£ à¤†à¤ªà¤£ à¤ªà¥�à¤¢à¥‡ à¤œà¤¾à¤Š à¤¶à¤•à¤¤à¥‹. à¤¤à¥�à¤®à¤šà¥€ à¤•à¤¾à¤ªà¤£à¥€ à¤†à¤§à¥€à¤š à¤�à¤¾à¤²à¥€ à¤†à¤¹à¥‡ à¤•à¤¾?",
        error_parsing: "à¤•à¥�à¤·à¤®à¤¸à¥�à¤µ, à¤®à¤²à¤¾ à¤¤à¥‡ à¤¸à¤®à¤œà¤£à¥�à¤¯à¤¾à¤¤ à¤…à¤¡à¤šà¤£ à¤†à¤²à¥€. à¤•à¥ƒà¤ªà¤¯à¤¾ à¤ªà¥�à¤¨à¥�à¤¹à¤¾ à¤¸à¤¾à¤‚à¤—à¤¾à¤² à¤•à¤¾?",
        camera_success: "à¤—à¥�à¤£à¤µà¤¤à¥�à¤¤à¤¾ à¤¡à¥‡à¤Ÿà¤¾à¤šà¥‡ à¤µà¤¿à¤¶à¥�à¤²à¥‡à¤·à¤£ à¤•à¥‡à¤²à¥‡. à¤¤à¥�à¤®à¥�à¤¹à¥€ à¤¤à¥�à¤®à¤šà¤¾ à¤®à¤¾à¤² à¤•à¤¸à¤¾ à¤¨à¥‡à¤£à¤¾à¤° à¤†à¤¹à¤¾à¤¤? à¤¦à¥�à¤šà¤¾à¤•à¥€, à¤Ÿà¥�à¤°à¥…à¤•à¥�à¤Ÿà¤° à¤•à¤¿à¤‚à¤µà¤¾ à¤ªà¤¿à¤•à¤…à¤ª à¤Ÿà¥�à¤°à¤•?"
    },
    "Tamil": {
        greeting: "à®µà®£à®•à¯�à®•à®®à¯�! à®¨à®¾à®©à¯� à®®à®¿à®Ÿà¯�à®Ÿà®¿à®®à®¿à®¤à¯�à®°à®¾. à®‰à®™à¯�à®•à®³à¯�à®•à¯�à®•à¯�à®šà¯� à®šà®¿à®±à®¨à¯�à®¤ à®²à®¾à®ªà®šà¯� à®šà®¨à¯�à®¤à¯ˆà®•à®³à¯ˆà®•à¯� à®•à®£à¯�à®Ÿà®±à®¿à®¯, à®‰à®™à¯�à®•à®³à¯� à®œà®¿à®ªà®¿à®Žà®¸à¯� à®®à®±à¯�à®±à¯�à®®à¯� à®ªà®¯à®¿à®°à¯� à®¤à®°à®µà¯ˆà®ªà¯� à®ªà®¯à®©à¯�à®ªà®Ÿà¯�à®¤à¯�à®¤ à®Žà®©à®•à¯�à®•à¯� à®…à®©à¯�à®®à®¤à®¿ à®¤à¯‡à®µà¯ˆ. à®¨à®¾à®©à¯� à®¤à¯Šà®Ÿà®°à®²à®¾à®®à®¾?",
        location_success: "à®‡à®°à¯�à®ªà¯�à®ªà®¿à®Ÿà®®à¯� à®‰à®±à¯�à®¤à®¿ à®šà¯†à®¯à¯�à®¯à®ªà¯�à®ªà®Ÿà¯�à®Ÿà®¤à¯�. à®‰à®™à¯�à®•à®³à¯� à®ªà®¯à®¿à®°à¯� à®�à®±à¯�à®•à®©à®µà¯‡ à®…à®±à¯�à®µà®Ÿà¯ˆ à®šà¯†à®¯à¯�à®¯à®ªà¯�à®ªà®Ÿà¯�à®Ÿà¯�à®µà®¿à®Ÿà¯�à®Ÿà®¤à®¾, à®…à®²à¯�à®²à®¤à¯� à®…à®¤à¯� à®®à¯�à®¤à®¿à®°à¯�à®šà¯�à®šà®¿à®¯à®Ÿà¯ˆà®¯à¯�à®®à¯� à®µà®°à¯ˆ à®•à®¾à®¤à¯�à®¤à®¿à®°à¯�à®•à¯�à®•à®¿à®±à¯€à®°à¯�à®•à®³à®¾?",
        location_error: "à®‡à®°à¯�à®ªà¯�à®ªà®¿à®Ÿà®¤à¯�à®¤à¯ˆà®ªà¯� à®ªà¯†à®±à¯�à®µà®¤à®¿à®²à¯� à®šà®¿à®•à¯�à®•à®²à¯� à®‰à®³à¯�à®³à®¤à¯�, à®†à®©à®¾à®²à¯� à®¨à®¾à®®à¯� à®¤à¯Šà®Ÿà®°à®²à®¾à®®à¯�. à®‰à®™à¯�à®•à®³à¯� à®ªà®¯à®¿à®°à¯� à®�à®±à¯�à®•à®©à®µà¯‡ à®…à®±à¯�à®µà®Ÿà¯ˆ à®šà¯†à®¯à¯�à®¯à®ªà¯�à®ªà®Ÿà¯�à®Ÿà¯�à®µà®¿à®Ÿà¯�à®Ÿà®¤à®¾?",
        error_parsing: "à®®à®©à¯�à®©à®¿à®•à¯�à®•à®µà¯�à®®à¯�, à®…à®¤à¯ˆà®ªà¯� à®ªà¯�à®°à®¿à®¨à¯�à®¤à¯�à®•à¯Šà®³à¯�à®µà®¤à®¿à®²à¯� à®Žà®©à®•à¯�à®•à¯�à®šà¯� à®šà®¿à®°à®®à®®à¯� à®‡à®°à¯�à®¨à¯�à®¤à®¤à¯�. à®¤à®¯à®µà¯�à®šà¯†à®¯à¯�à®¤à¯� à®®à¯€à®£à¯�à®Ÿà¯�à®®à¯� à®šà¯Šà®²à¯�à®² à®®à¯�à®Ÿà®¿à®¯à¯�à®®à®¾?",
        camera_success: "à®¤à®°à®¤à¯� à®¤à®°à®µà¯� à®ªà®•à¯�à®ªà¯�à®ªà®¾à®¯à¯�à®µà¯� à®šà¯†à®¯à¯�à®¯à®ªà¯�à®ªà®Ÿà¯�à®Ÿà®¤à¯�. à®‰à®™à¯�à®•à®³à¯� à®µà®¿à®³à¯ˆà®ªà¯Šà®°à¯�à®Ÿà¯�à®•à®³à¯ˆ à®Žà®ªà¯�à®ªà®Ÿà®¿ à®•à¯Šà®£à¯�à®Ÿà¯� à®šà¯†à®²à¯�à®µà¯€à®°à¯�à®•à®³à¯�? à®‡à®°à¯�à®šà®•à¯�à®•à®° à®µà®¾à®•à®©à®®à¯�, à®Ÿà®¿à®°à®¾à®•à¯�à®Ÿà®°à¯� à®…à®²à¯�à®²à®¤à¯� à®ªà®¿à®•à¯�à®•à®ªà¯� à®Ÿà®¿à®°à®•à¯�?"
    },
    "Telugu": {
        greeting: "à°¨à°®à°¸à±�à°•à°¾à°°à°‚! à°¨à±‡à°¨à±� à°®à°¿à°Ÿà±�à°Ÿà°¿à°®à°¿à°¤à±�à°°. à°®à±€à°•à±� à°‰à°¤à±�à°¤à°® à°²à°¾à°­à°¦à°¾à°¯à°•à°®à±ˆà°¨ à°®à°¾à°°à±�à°•à±‡à°Ÿà±�à°²à°¨à±� à°•à°¨à±�à°—à±Šà°¨à°¡à°¾à°¨à°¿à°•à°¿, à°®à±€ à°œà°¿à°ªà°¿à°Žà°¸à±� à°®à°°à°¿à°¯à±� à°ªà°‚à°Ÿ à°¡à±‡à°Ÿà°¾à°¨à±� à°‰à°ªà°¯à±‹à°—à°¿à°‚à°šà°¡à°¾à°¨à°¿à°•à°¿ à°¨à°¾à°•à±� à°®à±€ à°…à°¨à±�à°®à°¤à°¿ à°…à°µà°¸à°°à°‚. à°¨à±‡à°¨à±� à°•à±Šà°¨à°¸à°¾à°—à°¿à°‚à°šà°µà°šà±�à°šà°¾?",
        location_success: "à°¸à±�à°¥à°¾à°¨à°‚ à°—à±�à°°à±�à°¤à°¿à°‚à°šà°¬à°¡à°¿à°‚à°¦à°¿. à°®à±€ à°ªà°‚à°Ÿ à°‡à°ªà±�à°ªà°Ÿà°¿à°•à±‡ à°•à±‹à°¤à°•à±� à°µà°šà±�à°šà°¿à°‚à°¦à°¾, à°²à±‡à°¦à°¾ à°®à±€à°°à±� à°‡à°‚à°•à°¾ à°…à°¦à°¿ à°ªà°•à±�à°µà°¾à°¨à°¿à°•à°¿ à°°à°¾à°µà°¾à°²à°¨à°¿ à°Žà°¦à±�à°°à±�à°šà±‚à°¸à±�à°¤à±�à°¨à±�à°¨à°¾à°°à°¾?",
        location_error: "à°¸à±�à°¥à°¾à°¨à°¾à°¨à±�à°¨à°¿ à°ªà±Šà°‚à°¦à°¡à°‚à°²à±‹ à°‡à°¬à±�à°¬à°‚à°¦à°¿ à°‰à°‚à°¦à°¿, à°•à°¾à°¨à±€ à°®à°¨à°‚ à°®à±�à°‚à°¦à±�à°•à±� à°µà±†à°³à±�à°³à°µà°šà±�à°šà±�. à°®à±€ à°ªà°‚à°Ÿ à°‡à°ªà±�à°ªà°Ÿà°¿à°•à±‡ à°•à±‹à°¤à°•à±� à°µà°šà±�à°šà°¿à°‚à°¦à°¾?",
        error_parsing: "à°•à±�à°·à°®à°¿à°‚à°šà°‚à°¡à°¿, à°¦à°¾à°¨à±�à°¨à°¿ à°ªà±�à°°à°¾à°¸à±†à°¸à±� à°šà±‡à°¯à°¡à°‚à°²à±‹ à°¨à°¾à°•à±� à°‡à°¬à±�à°¬à°‚à°¦à°¿ à°•à°²à°¿à°—à°¿à°‚à°¦à°¿. à°¦à°¯à°šà±‡à°¸à°¿ à°®à°³à±�à°³à±€ à°šà±†à°ªà±�à°ªà°—à°²à°°à°¾?",
        camera_success: "à°¨à°¾à°£à±�à°¯à°¤ à°¡à±‡à°Ÿà°¾ à°µà°¿à°¶à±�à°²à±‡à°·à°¿à°‚à°šà°¬à°¡à°¿à°‚à°¦à°¿. à°®à±€à°°à±� à°®à±€ à°‰à°¤à±�à°ªà°¤à±�à°¤à±�à°²à°¨à±� à°Žà°²à°¾ à°°à°µà°¾à°£à°¾ à°šà±‡à°¸à±�à°¤à°¾à°°à±�? à°¦à±�à°µà°¿à°šà°•à±�à°° à°µà°¾à°¹à°¨à°‚, à°Ÿà±�à°°à°¾à°•à±�à°Ÿà°°à±� à°²à±‡à°¦à°¾ à°ªà°¿à°•à°ªà±� à°Ÿà±�à°°à°•à±�?"
    },
    "Gujarati": {
        greeting: "àª¨àª®àª¸à«�àª¤à«‡! àª¹à«�àª‚ àª®àª¿àª¤à«�àª¤à«€àª®àª¿àª¤à«�àª° àª›à«�àª‚. àª¤àª®àª¾àª°àª¾ àª®àª¾àªŸà«‡ àª¶à«�àª°à«‡àª·à«�àª  àª¨àª«àª¾àª•àª¾àª°àª• àª¬àªœàª¾àª°à«‹ àª¶à«‹àª§àªµàª¾ àª®àª¾àªŸà«‡, àª®àª¾àª°à«‡ àª¤àª®àª¾àª°àª¾ àªœà«€àªªà«€àª�àª¸ àª…àª¨à«‡ àªªàª¾àª•àª¨àª¾ àª¡à«‡àªŸàª¾àª¨à«‹ àª‰àªªàª¯à«‹àª— àª•àª°àªµàª¾àª¨à«€ àª®àª‚àªœà«‚àª°à«€ àªœà«‹àªˆàª� àª›à«‡. àª¶à«�àª‚ àª¹à«�àª‚ àª†àª—àª³ àªµàª§à«€ àª¶àª•à«�àª‚?",
        location_success: "àª¸à«�àª¥àª¾àª¨ àª®àª³à«€ àª—àª¯à«�àª‚. àª¶à«�àª‚ àª¤àª®àª¾àª°àª¾ àªªàª¾àª•àª¨à«€ àª²àª£àª£à«€ àª¥àªˆ àª—àªˆ àª›à«‡, àª…àª¥àªµàª¾ àª¤àª®à«‡ àª¹àªœà«� àªªàª£ àª¤à«‡àª¨àª¾ àªªàª¾àª•àªµàª¾àª¨à«€ àª°àª¾àª¹ àªœà«‹àªˆ àª°àª¹à«�àª¯àª¾ àª›à«‹?",
        location_error: "àª¸à«�àª¥àª¾àª¨ àª®à«‡àª³àªµàªµàª¾àª®àª¾àª‚ àª¸àª®àª¸à«�àª¯àª¾ àª¥àªˆ, àªªàª£ àª†àªªàª£à«‡ àª†àª—àª³ àªµàª§à«€ àª¶àª•à«€àª� àª›à«€àª�. àª¶à«�àª‚ àª¤àª®àª¾àª°àª¾ àªªàª¾àª•àª¨à«€ àª²àª£àª£à«€ àª¥àªˆ àª—àªˆ àª›à«‡?",
        error_parsing: "àª•à«�àª·àª®àª¾ àª•àª°àª¶à«‹, àª®àª¨à«‡ àª¤à«‡ àª¸àª®àªœàªµàª¾àª®àª¾àª‚ àª®à«�àª¶à«�àª•à«‡àª²à«€ àªªàª¡à«€. àª¶à«�àª‚ àª¤àª®à«‡ àª•à«ƒàªªàª¾ àª•àª°à«€àª¨à«‡ àª«àª°à«€àª¥à«€ àª•àª¹à«€ àª¶àª•àª¶à«‹?",
        camera_success: "àª—à«�àª£àªµàª¤à«�àª¤àª¾àª¨àª¾ àª¡à«‡àªŸàª¾àª¨à«�àª‚ àªµàª¿àª¶à«�àª²à«‡àª·àª£ àª•àª°àªµàª¾àª®àª¾àª‚ àª†àªµà«�àª¯à«�àª‚. àª¤àª®à«‡ àª¤àª®àª¾àª°à«€ àª‰àªªàªœàª¨à«�àª‚ àªªàª°àª¿àªµàª¹àª¨ àª•à«‡àªµà«€ àª°à«€àª¤à«‡ àª•àª°àª¶à«‹? àªŸà«� àªµà«�àª¹à«€àª²àª°, àªŸà«�àª°à«‡àª•à«�àªŸàª° àª…àª¥àªµàª¾ àªªàª¿àª•àª…àªª àªŸà«�àª°àª•?"
    },
    "Punjabi": {
        greeting: "à¨¸à¨¤à¨¿ à¨¸à©�à¨°à©€ à¨…à¨•à¨¾à¨²! à¨®à©ˆà¨‚ à¨®à¨¿à©±à¨Ÿà©€à¨®à¨¿à©±à¨¤à¨° à¨¹à¨¾à¨‚à¥¤ à¨¤à©�à¨¹à¨¾à¨¡à©‡ à¨²à¨ˆ à¨¸à¨­ à¨¤à©‹à¨‚ à¨µà¨§à©€à¨† à¨®à©�à¨¨à¨¾à¨«à¨¼à¨¾ à¨µà¨¾à¨²à©€à¨†à¨‚ à¨®à©°à¨¡à©€à¨†à¨‚ à¨²à©±à¨­à¨£ à¨²à¨ˆ, à¨®à©ˆà¨¨à©‚à©° à¨¤à©�à¨¹à¨¾à¨¡à©‡ à¨œà©€à¨ªà©€à¨�à¨¸ à¨…à¨¤à©‡ à¨«à¨¼à¨¸à¨² à¨¦à©‡ à¨¡à©‡à¨Ÿà¨¾ à¨¦à©€ à¨µà¨°à¨¤à©‹à¨‚ à¨•à¨°à¨¨ à¨¦à©€ à¨‡à¨œà¨¾à¨œà¨¼à¨¤ à¨šà¨¾à¨¹à©€à¨¦à©€ à¨¹à©ˆà¥¤ à¨•à©€ à¨®à©ˆà¨‚ à¨…à©±à¨—à©‡ à¨µà¨§ à¨¸à¨•à¨¦à¨¾ à¨¹à¨¾à¨‚?",
        location_success: "à¨²à©‹à¨•à©‡à¨¸à¨¼à¨¨ à¨®à¨¿à¨² à¨—à¨ˆ à¨¹à©ˆà¥¤ à¨•à©€ à¨¤à©�à¨¹à¨¾à¨¡à©€ à¨«à¨¼à¨¸à¨² à¨¦à©€ à¨•à¨Ÿà¨¾à¨ˆ à¨¹à©‹ à¨šà©�à©±à¨•à©€ à¨¹à©ˆ, à¨œà¨¾à¨‚ à¨¤à©�à¨¸à©€à¨‚ à¨…à¨œà©‡ à¨µà©€ à¨‡à¨¸ à¨¦à©‡ à¨ªà©±à¨•à¨£ à¨¦à©€ à¨‰à¨¡à©€à¨• à¨•à¨° à¨°à¨¹à©‡ à¨¹à©‹?",
        location_error: "à¨²à©‹à¨•à©‡à¨¸à¨¼à¨¨ à¨ªà©�à¨°à¨¾à¨ªà¨¤ à¨•à¨°à¨¨ à¨µà¨¿à©±à¨š à¨®à©�à¨¸à¨¼à¨•à¨² à¨†à¨ˆ à¨¹à©ˆ, à¨ªà¨° à¨…à¨¸à©€à¨‚ à¨…à©±à¨—à©‡ à¨µà¨§ à¨¸à¨•à¨¦à©‡ à¨¹à¨¾à¨‚à¥¤ à¨•à©€ à¨¤à©�à¨¹à¨¾à¨¡à©€ à¨«à¨¼à¨¸àª² à¨¦à©€ à¨•à¨Ÿà¨¾à¨ˆ à¨ªà¨¹à¨¿à¨²à¨¾à¨‚ à¨¹à©€ à¨¹à©‹ à¨šà©�à©±à¨•à©€ à¨¹à©ˆ?",
        error_parsing: "à¨®à¨¾à¨«à¨¼ à¨•à¨°à¨¨à¨¾, à¨®à©ˆà¨¨à©‚à©° à¨‡à¨¸ à¨¨à©‚à©° à¨¸à¨®à¨�à¨£ à¨µà¨¿à©±à¨š à¨®à©�à¨¸à¨¼à¨•à¨² à¨†à¨ˆ à¨¹à©ˆà¥¤ à¨•à©€ à¨¤à©�à¨¸à©€à¨‚ à¨•à¨¿à¨°à¨ªà¨¾ à¨•à¨°à¨•à©‡ à¨¦à©�à¨¬à¨¾à¨°à¨¾ à¨•à¨¹à¨¿ à¨¸à¨•à¨¦à©‡ à¨¹à©‹?",
        camera_success: "à¨—à©�à¨£à¨µà©±à¨¤à¨¾ à¨¦à©‡ à¨¡à©‡à¨Ÿà¨¾ à¨¦à¨¾ à¨µà¨¿à¨¸à¨¼à¨²à©‡à¨¸à¨¼à¨£ à¨•à©€à¨¤à¨¾ à¨—à¨¿à¨† à¨¹à©ˆà¥¤ à¨¤à©�à¨¸à©€à¨‚ à¨†à¨ªà¨£à©€ à¨‰à¨ªà¨œ à¨¦à©€ à¨¢à©‹à¨†-à¨¢à©�à¨†à¨ˆ à¨•à¨¿à¨µà©‡à¨‚ à¨•à¨°à©‹à¨—à©‡? à¨¦à©‹ à¨ªà¨¹à©€à¨† à¨µà¨¾à¨¹à¨¨, à¨Ÿà©�à¨°à©ˆà¨•à¨Ÿà¨°, à¨œà¨¾à¨‚ à¨ªà¨¿à¨•à¨…à©±à¨ª à¨Ÿà¨°à©±à¨•?"
    }
};
...
®…à®©à¯�à®®à®¤à®¿ à®¤à¯‡à®µà¯ˆ. à®¨à®¾à®©à¯� à®¤à¯Šà®Ÿà®°à®²à®¾à®®à®¾?";
        } else if (name === "Telugu") {
            greeting = "à°¨à°®à°¸à±�à°•à°¾à°°à°‚! à°¨à±‡à°¨à±� à°®à°¿à°Ÿà±�à°Ÿà°¿à°®à°¿à°¤à±�à°°. à°®à±€à°•à±� à°‰à°¤à±�à°¤à°® à°²à°¾à°­à°¦à°¾à°¯à°•à°®à±ˆà°¨ à°®à°¾à°°à±�àª•à«‡à°Ÿà±�à°²à°¨à±� à°•à°¨à±�à°—à±Šà°¨à°¡à°¾à°¨à°¿à°•à°¿, à°®à±€ à°œà°¿à°ªà°¿à°Žà°¸à±� à°®à°°à°¿à°¯à±� à°ªà°‚à°Ÿ à°¡à±‡à°Ÿà°¾à°¨à±� à°‰à°ªà°¯à±‹à°—à°¿à°‚à°šà°¡à°¾à°¨à°¿à°•à°¿ à°¨à°¾à°•à±� à°®à±€ à°…à°¨à±�à°®à°¤à°¿ à°…à°µà°¸à°°à°‚. à°¨à±‡à°¨à±� à°•à±Šà°¨à°¸à°¾à°—à°¿à°‚à°šà°µà°šà±�à°šà°¾?";
                        ...
                        >
                            <GlassCard className="h-full flex flex-col p-6 lg:p-10 border-mint/10 overflow-hidden relative group shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                                ...
                                >
                                    <LedgerItem 
                                        label="DPDP Consent" 
                                        value={consentGranted ? "Granted âœ…" : "Pending..."} 
                                    ...
                                    <LedgerItem 
                                        ...
                                        value={location ? "Located âœ…" : (gpsError ? "Manual ðŸ“�" : "Finding...")} 
